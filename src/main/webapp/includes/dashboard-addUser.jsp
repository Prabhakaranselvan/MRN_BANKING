  ...
  <form id="MRN-Form" class="mrn-form">
    ...
    <div class="double-column">
      <div class="part">
        ...
        <input class="form-input" type="text" name="name" placeholder="Name" pattern="[A-Za-z]+(?:[\-' ][A-Za-z]+)*" required>
      </div>
    ...
    <div class="double-column client-only">
      ...
      <div class="part">
        ...
        <input class="form-input" type="text" id="pan" name="pan" maxlength="10" pattern="[A-Z]{5}\d{4}[A-Z]" oninput="this.value = this.value.toUpperCase();">
      </div>
    </div>
    ...
    <div class="double-column">
      <div class="part">
        ...
        <input class="form-input" type="password" id="password" name="password" maxlength="20" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[\W_]).{8,20}" required>
      </div>
      <div class="part">
        <label class="form-label" for="confirm-password">Confirm Password <span class="required">*</span></label>
        <input class="form-input" type="password" id="confirm-password" name="confirm_password" maxlength="20" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[\W_]).{8,20}" required>
      </div>
    </div>
