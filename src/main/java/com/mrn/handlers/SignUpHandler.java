	...
	public Map<String, Object> handlePost(Object pojoInstance, Map<String, Object> attributeMap) throws InvalidException 
    {
        try 
        {
            ...
            if (success) 
            {
                ...
                responseMap.put("message", "SignUp Successfully");
            ...
            else 
            {
                ...
                throw new InvalidException("SignUp Failed");
            } 
        } 
        ...
        {
            ConnectionManager.rollback();
            throw new InvalidException("SignUp failed due to an unexpected error", e);
        } 
        finally 
        {
